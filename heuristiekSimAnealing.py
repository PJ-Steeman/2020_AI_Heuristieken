...
def main():
    ...
    print("Input file: " + pathIn + "   -----   Output file: " + pathOut + "   -----   Maximum runtime: " + str(max_time))
    ...
    #Zolang er nog tijd is (- 4* de read tijd om alles nog weg te kunnen schrijven)
    while (time.time() - start_time) < (max_time - 4*read_time):
        # Simulated annealing
        while T >= MIN_T:
